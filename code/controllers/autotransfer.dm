...
datum/controller/transfer_controller/New()
	...
	shift_hard_end = config.vote_autotransfer_initial + (config.vote_autotransfer_interval * 3) //VOREStation Edit //Change this "1" to how many extend votes you want there to be.
